...
> youtube https://www.youtube.com/watch?v=wn6C_XEv1Mo
...
**Swift 6 got everyone talking too**, especially with more thread safety being introduced. Having [Matt Masicotte](/episodes/194-fear-of-the-main-thread-with-matt-masicotte) on the podcast to chat about it was always a hit. 
...
This change doesn't mean I'm stopping my other work though. I'm just approaching it differently. For app development, I'm going to focus on smaller apps and [implement Jordi's 2-2-2 method](/episodes/136-posture-island-with-jordi-bruin/). I'll continue updating my existing apps, including the ongoing rewrite of Heartwitch (soon to be rebranded as Bitness).

> youtube https://www.youtube.com/watch?v=zkjEFxhAelI

[**Bushel**](https://getbushel.app/) development will continue in 2025, and I've got some exciting plans there. I've already started open-sourcing parts of the codebase:

- [**DataThespian**](https://github.com/brightdigit/DataThespian) My library for interfacing with SwiftData using model actors for background operations
