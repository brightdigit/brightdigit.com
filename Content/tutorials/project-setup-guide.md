...
the next step is setting up some sort of tool which will help consolidate the external tools we'll use while keeping them consistent across a development team and its continuous integration setup.
