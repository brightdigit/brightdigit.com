...
internal final class ModifierTests: XCTestCase {
  internal func testModifierInput() {
  ...
  internal func testInitializingParserWithModifiers() {
    let parser = MarkdownParser(modifiers: [
  ...
  internal func testAddingModifiers() {
  ...
  internal func testMultipleModifiersForSameTarget() {
    var parser = MarkdownParser()
...
extension ModifierTests {
  internal static var allTests: Linux.TestList<ModifierTests> {
    [
