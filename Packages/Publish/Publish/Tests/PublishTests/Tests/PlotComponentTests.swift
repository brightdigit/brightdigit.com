...
internal final class PlotComponentTests: PublishTestCase {
  internal func testStylesheetPaths() {
    let head = Node.head(
  ...
  internal func testRenderingAudioPlayer() throws {
  ...
  internal func testRenderingHostedVideoPlayer() throws {
