...
internal final class IndentationTests: XCTestCase {
  internal func testSpacesCoding() throws {
  ...
  internal func testTabsCoding() throws {
  ...
  internal func testDecodingErrorForInvalidKind() throws {
