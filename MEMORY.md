...
- [Branch dependency release checkpoint](.claude/memory/dependency-release-checkpoint.md) — Packages is temporarily absent; root uses working branches until package tags replace them, then subrepos return for v2.0.0-alpha.2
